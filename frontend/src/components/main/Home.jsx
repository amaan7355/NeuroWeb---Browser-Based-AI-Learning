...
const Home = () => {
  ...
  const makeSubscription = (planDetails, link) => {
    sessionStorage.setItem('plan', JSON.stringify(planDetails));
                          ...
                          <div className='App mb-5'>
                            <span className='display-6' style={{ color: 'white', fontWeight: 'bold', }}>
                              ...
                              <Typewriter
                                ...
                                delaySpeed={1000}
                              />
                              {/* <h1 className="display-6 fw-bold mb-4" style={{ color: "hsl(220, 81%, 86%)" }}>
                            Model Training{' '}
                          </h1> */}
                            </span>
                    ...
                    <div className="col-lg-4 col-md-12 p-0 py-5">
                      ...
                      <div className="card h-100 rounded-lg-top-end rounded-lg-bottom-end">
                        ...
                        <div className="card-header text-center pt-4">
                          ...
                          <button
                            onClick={() => {
                              makeSubscription({ name: 'Basic', amount: 250 }, "https://buy.stripe.com/test_4gweVF3GD1SH7NSfYY")
                            }}
                            type="button"
                    ...
                    <div className="col-lg-4 p-0">
                      ...
                      <div className="card h-100 shadow-5" style={{ zIndex: 1 }}>
                        ...
                        <div className="card-header text-center pt-4">
                          ...
                          <button
                          onClick={() => {
                            makeSubscription({ name: 'Enterprise', amount: 1000 }, "https://buy.stripe.com/test_28o14P3GD54T9W0cMO")
                          }}
                            type="button"
                    ...
                    <div className="col-lg-4 p-0 py-5">
                      ...
                      <div className="card h-100 rounded-lg-top-start rounded-lg-bottom-start">
                        ...
                        <div className="card-header text-center pt-4">
                          ...
                          <button
                          onClick={() => {
                            makeSubscription({ name: 'Advanced', amount: 500 }, 'https://buy.stripe.com/test_9AQ7tda5154T1pubIJ')
                          }}
                            type="button"
                            className="btn btn-link w-100 mb-3"
                            style={{ backgroundColor: "hsl(0, 0%, 95%)" }}
